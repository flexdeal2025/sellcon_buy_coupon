...
>(({ className, children, ...props }, ref) => (
  <DialogPrimitive.Portal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // 모바일: 하단 시트 느낌 / 데스크톱: 중앙 모달
        "fixed z-50 grid w-full gap-4 border bg-background p-5 shadow-lg duration-200",
        "left-0 right-0 bottom-0 rounded-t-2xl max-h-[92vh] overflow-y-auto",
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
        "sm:left-1/2 sm:top-1/2 sm:bottom-auto sm:right-auto sm:max-w-lg sm:-translate-x-1/2 sm:-translate-y-1/2 sm:rounded-2xl",
